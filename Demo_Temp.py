...
def data_get():
  city =city_name.get()
  data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=c340cf7baee953054e2850aaf0349a84").json()
...
name_label = Label(win, text="Chi Weather App",
